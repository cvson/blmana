...
gr2fit4point[iblm]->GetXaxis()->SetLimits(0,250);//newadd
gr2fit4point[iblm]->SetMinimum(0);
...
gPad->Print("/export/jnulsv01/home/cvson/public_html/beamloss/beamscan/"+subname+"allBLM_4intense.eps");
...
gPad->Print("/export/jnulsv01/home/cvson/public_html/beamloss/beamscan/"+subname+"allBLM_4intense_ssemout.eps");
// plot correlation between BLM and Si
TH2F* Si01_vs_blm01 = (TH2F*)pfile->Get("Si01_vs_blm01");

TH2F* Si02_vs_blm16 = (TH2F*)pfile->Get("Si02_vs_blm16");
new TCanvas;
Si02_vs_blm16->GetXaxis()->SetTitle("Integrated ADC of BLM01,16");
Si02_vs_blm16->GetYaxis()->SetTitle("Integrated ADC of Si 01,02");
titleStyle(Si01_vs_blm01);
Si02_vs_blm16->SetMarkerStyle(2);
Si02_vs_blm16->Draw("SCAT");
Si01_vs_blm01->SetMarkerColor(2);
Si01_vs_blm01->SetMarkerStyle(4);
Si01_vs_blm01->Draw("SCAT SAME");
TLegend* legn = new TLegend(.2, .7, 0.45, .85);
    legn->SetFillStyle(0);
    legn->SetBorderSize(0);
    legn->SetTextSize(0.037);
   legn->AddEntry(Si01_vs_blm01,"Si01 vs BLM01 (@up-PV1)","p");
   legn->AddEntry(Si02_vs_blm16,"Si02 vs BLM16 (@down-PC4-right)","p");
legn->Draw("same");
gPad->Print("plots/"+subname+"si_vsblm.eps");
}
