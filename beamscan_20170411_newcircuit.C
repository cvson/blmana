...
void beamscan_20170411_newcircuit(){
...
//50 shot on 20170406
//pchain->Add(Form("rootfilesct/run%07d_blmct.root",740026));
//scan 20170411
pchain->Add(Form("rootfilesct/run%07d_blmct.root",740052));
pchain->Add(Form("rootfilesct/run%07d_blmct.root",740053));

hAnaBeamMe *pAnalysis = new hAnaBeamMe();
pAnalysis->Init(pchain);
pAnalysis->BeamScan20170411newcircuit("beamscan_20170411_newcircuit.root");
